...
const APP_UPDATE_MESSAGE = "Atualização aplicada: logo removido, tela de login obrigatória e acesso aos dados somente após autenticação.";
  ...
  document.getElementById("root").innerHTML = html`
    <div class="app-shell">
      <header class="app-header">
        <div class="brand-mark"><div><div class="brand-title">uselivinha</div><div class="brand-subtitle">controle de despesas</div></div></div>
